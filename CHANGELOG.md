...
- The staging Worker has the same hourly trigger as production, so the catalog refresh and the TheMealDB mirror can be verified on staging before a release.
