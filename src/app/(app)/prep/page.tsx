...
function PrepContent() {
  ...
  return <div>
    ...
    <div className="my-6 flex flex-wrap items-center gap-4"><Link href="/meal-plan/" className="inline-flex min-h-11 items-center text-sm underline underline-offset-4">Open meal plan</Link><Link href="/shopping/" className="inline-flex min-h-11 items-center text-sm underline underline-offset-4">Open shopping</Link></div>
