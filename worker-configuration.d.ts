/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bbe8b3d4c0724f6fb0e4124c9b8f8b08)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	EMAIL: SendEmail;
	PROVIDER_LIMITER: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	BETTER_AUTH_URL: "https://pantry-pal-staging.refinalophaina.workers.dev" | "https://pantry.ainadara.com" | "http://localhost:8787";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "AUTH_EMAIL_FROM" | "AUTH_EMAIL_ENABLED" | "BETTER_AUTH_SECRET">> {}
}
